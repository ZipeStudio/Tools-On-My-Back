package me.zipestudio.tomb.utils.yacl.extension;
...
import java.util.*;
import me.zipestudio.tomb.utils.yacl.state.PreviewStateManager;
	...
	private static Version getCurrentYACLVersion() {
		return FabricLoader.getInstance().getModContainer("yet_another_config_lib_v3").orElseThrow(
				() -> new NoSuchElementException(
						"Failed to find Yet Another Config Lib [YACL], this shouldn't happen! Please report this crash to discord server of %s mod!".formatted(TOMBServer.MOD_NAME)
				)
